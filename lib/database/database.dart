...
abstract class TempDatabaseService {
  ...
  Future<void> saveUserAddress({required String userAddress});
...
class TempDatabaseImpl extends TempDatabaseService {
  ...
  Future<String> getUserAddress() async =>
      await securedStorage.read(key: 'USER_ADDRESS') ?? '';

  @override
  Future<void> saveUserAddress({required String userAddress}) async =>
      await securedStorage.write(key: 'USER_ADDRESS', value: userAddress);
